...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiY2FyYWxhZ3VtZW4iLCJhIjoiY2syZHVwOTg1MDJyYTNudDg1dGhuYm5vbSJ9.M9qJwdkhKLoNpo8p7s2wBg';
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            //GO TO HOMEPAGE IF SUCCESSFUL SIGN UP
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            ...
            //GO TO HOMEPAGE IF SUCCESSFUL LOG IN
            if (res.data.status === "success") {
              (0, _alerts.showAlert)('success', "Logged in successfully."); // alert(`Logged in successfully.`);
          ...
          case 7:
            ...
            (0, _alerts.showAlert)("error", _context2.t0.response.data.message); // console.log(err.response.data.message);
...
var stripe = Stripe('pk_test_fI5iiQeytwuL0QgaxPTmuO4O00lwpOqTWu');
...
if (userDataForm) {
  userDataForm.addEventListener('submit', function (e) {
    ...
    (0, _updateSettings.updateSettings)(form, 'data'); //WITHOUT API
...
if (bookBtn) {
  bookBtn.addEventListener('click', function (e) {
    ...
    var tourId = e.target.dataset.tourId; //tourId IMMEDIATELY CORRESPONDS WITH tour-id IN HTML
